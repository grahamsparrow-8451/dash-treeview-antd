...
- data (default {  title: 'Parent',  key: '0',  children: [{    title: 'Child',    key: '0-0',    children: [      { title: 'Subchild', key: '0-0-1', toolTip: '0-0-1' },      { title: 'Subchild', key: '0-0-2' },      { title: 'Subchild', key: '0-0-3' },    ],  }]}):
    Tree data.
